...
## Capabilities
- **Capabilities section:** A simple filterable index with high-level lane buttons and minimal rectangular cards, each opening into its own capability subpage.
...
## Team
- **Ali Ahmed**: Mechanical Engineer and Founder with a multidisciplinary background bridging physical engineering, advanced software architecture, and UX design...
