...
export const env: EnvShape = {
  ...
  supabaseAnonKey: getValue('NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY', getValue('NEXT_PUBLIC_SUPABASE_ANON_KEY')),
  supabaseServiceRoleKey: getValue('SUPABASE_SECRET_KEY', getValue('SUPABASE_SERVICE_ROLE_KEY')),
