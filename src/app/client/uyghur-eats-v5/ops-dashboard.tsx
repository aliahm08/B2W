            ...
            <aside className="w-64 border-r border-neutral-200 bg-white hidden md:flex flex-col sticky top-0 h-screen overflow-y-auto">
                <div className="p-8 border-b border-neutral-100 flex flex-col gap-4">
                    <div className="flex flex-col gap-4">
                        <Link to={basePath} className="inline-flex items-center gap-2 text-xs font-medium text-neutral-500 hover:text-black transition-colors bg-neutral-100 hover:bg-neutral-200 px-4 py-2 rounded-full self-start">
            ...
            <main className="flex-1 px-6 md:px-16 py-24 max-w-5xl mx-auto space-y-24">
                ...
                <div className="md:hidden flex flex-col gap-4 mb-12">
                    <div className="flex items-center justify-between w-full">
                        <Link to={basePath} className="inline-flex items-center gap-2 text-xs font-medium text-neutral-500 hover:text-black transition-colors bg-white hover:bg-neutral-50 px-4 py-2 rounded-full border border-neutral-200">
                            <ArrowLeft className="w-4 h-4" />
                            Return
                        </Link>
