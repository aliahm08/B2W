...
import { ArrowRight, TrendingUp, LayoutTemplate, BriefcaseBusiness, Target, ShieldCheck, LineChart, FileText, Scale, Clock, DollarSign } from 'lucide-react';
...
export default function UyghurEatsProposalHub() {
  ...
  const subPages = [
    ...
    {
      title: 'Valuation',
      path: '/portal/uyghur-eats/analysis',
    ...
    {
      title: 'Dashboard',
      path: '/portal/uyghur-eats/dashboard',
  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-black selection:text-white pb-32">
      ...
      <nav className="border-b border-neutral-100 flex items-center justify-between px-6 md:px-10 py-4">
        ...
        <div className="text-[10px] font-mono uppercase tracking-widest text-neutral-400">Uyghur Eats Portal v3</div>
      </nav>
