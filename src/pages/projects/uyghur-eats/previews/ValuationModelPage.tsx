...
export default function BasicPreviewPage() {
  ...
  return (
    <PreviewPageFrame
      ...
      description="Preview of the Uyghur Eats valuation presentation showing how revenue, normalized earnings, and sale scenarios can be packaged for buyer review."
