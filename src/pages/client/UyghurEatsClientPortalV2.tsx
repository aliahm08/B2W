...
export default function UyghurEatsClientPortalV2() {
    ...
    const packageSections: Record<string, { id: string; label: string; icon?: any; content: ReactNode }[]> = {
        ...
        terms: [
            { id: 'exclusivity', label: 'Exclusivity', content: <TermRow label="Exclusivity" detail="Engagement is exclusive for a period of 4 months from signing." /> },
            { id: 'fees', label: 'Success Fee', content: <TermRow label="Success Fee" detail="Payable only upon successful transaction or capital raise." /> },
            { id: 'confidentiality', label: 'Confidentiality', content: <TermRow label="Confidentiality" detail="Mutual NDA covers all financial and operational disclosures." /> },
        ],
    };
