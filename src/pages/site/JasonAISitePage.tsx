...
function OverviewPage() {
  return (
    <>
      <PageIntro eyebrow="JasonAI · The B2W Assistant" title="Ask the business what happened—without rereading every message." description="JasonAI searches the communication your company approves and turns long job threads into concise summaries through WhatsApp. It is $99 per month, with a one-time $2,000 WhatsApp integration and onboarding fee." primary={{ label: 'Book a founder review', to: 'mailto:info@b2w-ai.com', variant: 'product' }} secondary={{ label: 'Review pricing', to: '/products/pricing' }} tone="rust" />
...
function HowItWorksPage() {
  return (
    <>
      <PageIntro eyebrow="JasonAI · How It Works" title="Configure around the operation, then keep the interaction simple." description="The current experience begins with an approved source boundary and ends with a person reviewing the retrieved context or summary." primary={{ label: 'Request a fit review', to: 'mailto:info@b2w-ai.com', variant: 'product' }} tone="rust" />
...
function QuestionsPage() {
  return (
    <>
      <PageIntro eyebrow="JasonAI · Questions" title="Direct answers about fit, access, boundaries, and price." description="The questions page is designed to resolve uncertainty before asking for a commercial commitment." primary={{ label: 'Book a founder review', to: 'mailto:info@b2w-ai.com', variant: 'product' }} tone="rust" />
...
function PrivacyPage() {
  return (
    <>
      <PageIntro eyebrow="JasonAI · Privacy" title="The customer controls access. People remain accountable for action." description="This page explains the current data boundary in plain language. It is a product and trust statement, not a claim that any system can eliminate risk." primary={{ label: 'Ask a privacy question', to: 'mailto:info@b2w-ai.com', variant: 'product' }} tone="rust" />
      ...
      <CTASection eyebrow="Privacy request" title="Ask what JasonAI can access before approving a source." description="B2W will explain the proposed source boundary, the current workflow, and the human-review expectation during setup." action={{ label: 'Contact B2W about privacy', to: 'mailto:info@b2w-ai.com', variant: 'product' }} tone="rust" />
    </>
  );
}
