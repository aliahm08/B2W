...
export default function CapabilitiesKitchen() {
  const [activeRecipeId, setActiveRecipeId] = useState<string | null>(null);

  const activeRecipe = activeRecipeId ? recipes.find((recipe) => recipe.id === activeRecipeId) : null;
  ...
  return (
    <div className="py-32 px-6 max-w-7xl mx-auto">
      <motion.div
        ...
        className="mb-16"
      >
        <h2 className="text-4xl font-medium tracking-tight mb-4">Capabilities Kitchen</h2>
        <p className="max-w-3xl text-base text-neutral-600 leading-relaxed mb-6">
          This is the archived kitchen model of our capabilities section, including the original text,
          graphics, animations, and engineering.
          <br />
          <br />
          <strong>Select a solution below</strong> to see how the archived inputs combine into measurable outcomes.
        </p>
          ...
          {activeRecipe && (
            ...
            >
              <div>
                ...
                <p className="text-neutral-400 text-sm max-w-2xl leading-relaxed">{activeRecipe.description}</p>
              </div>
