...
export const protectedProjects: ProtectedProjectConfig[] = [
  {
    ...
    overlayTop: 780,
    maskedTitle: 'Confidential Marketing Proposal',
    maskedClientDescription: 'Confidential food and beverage client',
    ...
    maskedImpact: 'Confidential client metrics',
    maskedSeoTitle: 'Confidential Project Proposal',
    maskedSeoDescription: 'This proposal is access-controlled. Enter an approved email or password to reveal the client name and profile details.',
    ...
    teaserSummary: 'Use an approved proposal email to review the proposal view, or enter the business-profile password to reveal the full client profile and supporting documentation.',
  },
  {
    ...
    subtitle: 'Choose proposal access with an approved email, or enter the business-profile password.',
    overlayTop: 720,
    maskedTitle: 'Confidential Operations Prototype',
    maskedClientDescription: 'Confidential food and beverage client',
    ...
    maskedImpact: 'Confidential operating metrics',
  ...
  },
  {
    ...
    subtitle: 'Choose proposal access with an approved email, or enter the business-profile password.',
    overlayTop: 760,
    maskedTitle: 'Confidential Acquisition Profile',
    maskedClientDescription: 'Confidential hospitality client',
    ...
    maskedImpact: 'Confidential valuation metrics',
