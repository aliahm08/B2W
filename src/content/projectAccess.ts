...
export const protectedProjects: ProtectedProjectConfig[] = [
  ...
  },
  {
    ...
    overlayTop: 760,
    maskedTitle: 'Analysis Profile',
    maskedClientDescription: 'Restaurant property sale opportunity',
    maskedDescription: 'Client name, location, and diligence details stay hidden until profile access is verified.',
    maskedImpact: 'Property sale opportunity identified',
    maskedSeoTitle: 'Confidential Analysis Profile',
    maskedSeoDescription: 'This analysis profile is access-controlled. Enter the business-profile password to reveal the client name and business details.',
    teaserEyebrow: 'Access-Controlled Analysis Profile',
